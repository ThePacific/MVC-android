...
public final class OkReceiver extends BroadcastReceiver {
  ...
  public OkReceiver addConsumer(@Nonnull IntentFilter intentFilter, @Nonnull String action,
  ...
  public OkReceiver clearConsumer() {
    consumers.clear();
    return this;
  }

  public OkReceiver removeConsumer(@Nonnull String action) {
    Preconditions.checkState(!TextUtils.isEmpty(action));
