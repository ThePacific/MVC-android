package com.pacific.common.text;
...
public class Spannable extends SpannableStringBuilder {

  private int flag = android.text.Spannable.SPAN_EXCLUSIVE_EXCLUSIVE;

  public Spannable() {
    super("");
  }

  public Spannable(CharSequence text) {
    super(text);
  }

  public Spannable(CharSequence text, Object... spans) {
    super(text);
  ...
  public Spannable(CharSequence text, Object span) {
    super(text);
   ...
   * @return this {@code Spannable}.
   */
  public Spannable append(CharSequence text, Object... spans) {
    append(text);
    for (Object span : spans) {
  ...
  public Spannable append(CharSequence text, Object span) {
    append(text);
    setSpan(span, length() - text.length(), length());
    return this;
  }
   ...
   * @return this {@code Spannable}.
   */
  public Spannable append(CharSequence text, ImageSpan imageSpan) {
    text = "." + text;
    append(text);
   ...
   */
  @Override
  public Spannable append(CharSequence text) {
    super.append(text);
    return this;
  }
   ...
   * @return {@code Spannable}.
   */
  public Spannable findAndSpan(CharSequence textToSpan, GetSpan getSpan) {
    int lastIndex = 0;
    while (lastIndex != -1) {
