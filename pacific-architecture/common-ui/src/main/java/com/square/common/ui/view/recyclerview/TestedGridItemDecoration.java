package com.square.common.ui.view.recyclerview;
...
import com.pacific.guava.android.context.ContextExtensionsKt;
...
public class TestedGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public TestedGridItemDecoration(Context context, @DimenRes int inserts, @ColorRes int color) {
        mDivider = new ColorDrawable(ContextExtensionsKt.toColor(context, color));
