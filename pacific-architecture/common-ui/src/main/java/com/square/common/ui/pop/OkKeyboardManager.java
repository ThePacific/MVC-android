 ...
 */
public final class OkKeyboardManager implements PopupWindow.OnDismissListener {
    ...
    public OkKeyboardManager(@NonNull Activity activity, @LayoutRes int keyboardLayout) {
        this(activity, keyboardLayout, null);
    }

    public OkKeyboardManager(
