package com.pacific.app.architecture.data.http.okhttp3;

import com.pacific.app.architecture.data.http.okhttp3.WarnIfSlow;
...
public class WarnIfSlowInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        com.pacific.app.architecture.data.http.okhttp3.WarnIfSlow warnIfSlow = invocation.method().getAnnotation(WarnIfSlow.class);
