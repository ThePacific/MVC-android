...
package com.pacific.guava.android.ui.view.viewpager;
...
public final class TabLayoutMediator2 {
        ...
        public void onPageSelected(final int position) {
            ...
            if (tabLayout != null
                ...
                if (onTabSelectedListener != null) {
                    onTabSelectedListener.ignoreTabSelectedEvent = true;
                }
    ...
    private static class ViewPagerOnTabSelectedListener implements TabLayout.OnTabSelectedListener {
        private final ViewPager2 viewPager;
        private boolean ignoreTabSelectedEvent = false;
        ...
        public void onTabSelected(@NonNull TabLayout.Tab tab) {
            if (ignoreTabSelectedEvent) {
                ignoreTabSelectedEvent = false;
                return;
            }
